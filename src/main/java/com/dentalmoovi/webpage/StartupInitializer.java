...
public class StartupInitializer {
    ...
    public void init(){
        ...
        Products adhesivo1 = new Products(null, "Adhesivo1", 10000, "description adhesivo1", 4, 1, adhesivos, null);
        Products adhesivo2 = new Products(null, "Adhesivo2", 12000, "description adhesivo2", 4, 1, adhesivos, null);
        Products alambre1 = new Products(null, "Alambre1", 10000, "description alambre1", 4, 1, alambres, null);
        Products alambre2 = new Products(null, "Alambre2", 12000, "description alambre2", 4, 1, alambres, null);
        Products arco1 = new Products(null, "Arco1", 10000, "description arco1", 4, 1, arcos, null);
        Products arco2 = new Products(null, "Arco2", 12000, "description arco2", 4, 1, arcos, null);
        Products auxiliar1 = new Products(null, "Auxiliar1", 12000, "description Auxiliar1", 4, 1, auxiliares, null);
        Products auxiliar2 = new Products(null, "auxiliar2", 12000, "description auxiliar2", 4, 1, auxiliares, null);
        Products bisacrilico1 = new Products(null, "bisacrilico1", 12000, "description bisacrilico1", 4, 1, bisacrilicos, null);
        Products bisacrilico2 = new Products(null, "bisacrilico2", 12000, "description bisacrilico2", 4, 1, bisacrilicos, null);
        Products carrierBraket1 = new Products(null, "carrierBraket1", 12000, "description carrierBraket1", 4, 1, brakets, null);
        Products cemento1 = new Products(null, "cemento1", 12000, "description cemento1", 4, 1, cemento, null);
        Products cepilloOral = new Products(null, "cepilloOral", 12000, "description cepilloOral", 4, 1, cuidadoDental, null);
        Products compomero1 = new Products(null, "compomero1", 12000, "description compomero1", 4, 1, compomeros, null);
        Products compomero2 = new Products(null, "compomero2", 12000, "description compomero2", 4, 1, compomeros, null);
        Products deltaForceBraket1 = new Products(null, "deltaForceBraket1", 12000, "description deltaForceBraket1", 4, 1, brakets, null);
        Products distalizador1 = new Products(null, "distalizador1", 12000, "description distalizador1", 4, 1, distalizador, null);
        Products distalizador2 = new Products(null, "distalizador2", 12000, "description distalizador2", 4, 1, distalizador, null);
        Products elastomeros1 = new Products(null, "elastomeros1", 12000, "description elastomeros1", 4, 1, elastomeros, null);
        Products elastomeros2 = new Products(null, "elastomeros2", 12000, "description elastomeros2", 4, 1, elastomeros, null);
        Products estandarBraket1 = new Products(null, "estandarBraket1", 12000, "description estandarBraket1", 4, 1, brakets, null);
        Products estandarBraket2 = new Products(null, "estandarBraket2", 12000, "description estandarBraket2", 4, 1, brakets, null);
        Products guantesLatex = new Products(null, "guantesLatex", 12000, "description guantesLatex", 4, 1, desechables, null);
        Products hojaBisturi1 = new Products(null, "hojaBisturi1", 12000, "description hojaBisturi1", 4, 1, hojaBisturi, null);
        Products hojaBisturi2 = new Products(null, "hojaBisturi2", 12000, "description hojaBisturi2", 4, 1, hojaBisturi, null);
        Products instrumentoOrtodoncia1 = new Products(null, "instrumentoOrtodoncia1", 12000, "description instrumentoOrtodoncia1", 4, 1, instrumentosOrtodonticos, null);
        Products instrumentoOrtodoncia2 = new Products(null, "instrumentoOrtodoncia2", 12000, "description instrumentoOrtodoncia2", 4, 1, instrumentosOrtodonticos, null);
        Products jeringa1 = new Products(null, "jeringa1", 12000, "description jeringa1", 4, 1, jeringas, null);
        ...
        Products pinzaDental2 = new Products(null, "pinzaDental2", 12000, "description pinzaDental2", 4, 1, pinzasDental, null);
        Products pinzaOrtodoncia1 = new Products(null, "pinzaOrtodoncia1", 12000, "description pinzaOrtodoncia1", 4, 1, pinzasOrtodoncia, null);
        Products pinzaOrtodoncia2 = new Products(null, "pinzaOrtodoncia2", 12000, "description pinzaOrtodoncia2", 4, 1, pinzasOrtodoncia, null);
